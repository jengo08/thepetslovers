...
<head>
  ...
  <style>
    ...
    /* ===== Mascotas: lista vertical, avatar redondo pequeño ===== */
    #reservaForm.compact #petsGrid{
      display:flex; flex-direction:column; gap:8px;
    }
    #reservaForm.compact .tpl-pet-item{
      position:relative; display:flex; align-items:center; gap:10px;
      border:1px solid #ece8f0; background:#fff; border-radius:10px; padding:8px 10px;
      box-shadow:0 1px 6px rgba(0,0,0,.04);
    }
    #reservaForm.compact .tpl-pet-thumb{
      width:40px; height:40px; border-radius:999px; object-fit:cover; border:2px solid #eee;
      flex:0 0 40px;
    }
    #reservaForm.compact .tpl-pet-icon{
      width:40px; height:40px; border-radius:999px; display:flex; align-items:center; justify-content:center; border:2px solid #eee; color:#9aa0a6; font-size:16px;
      flex:0 0 40px;
    }
    ...
    #reservaForm.compact .tpl-pet-sub{ color:#7b6f86; font-size:.88rem; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
...
<body>
  ...
  <div class="page">
    ...
    <div class="shell">
      ...
      <form id="reservaForm" class="card compact disabled" novalidate>
        ...
        <div class="row-3">
          <div class="field">
            ...
            <select id="serviceType" required>
              ...
              <option value="exoticos_mamiferos">Visita exóticos (mamíferos)</option>
        ...
        <!-- Controles específicos visitas gato -->
        ...
        <div class="g-3 grid">
          ...
          <div class="field">
            <label for="isPuppyDisplay">Cachorro (≤6 m)</label>
            <select id="isPuppyDisplay" disabled><option value="no">No</option><option value="si">Sí</option></select>
          </div>
  ...
  <!-- Lógica principal (archivo completo debajo) -->
  <script src="tpl-reservas.js" defer></script>

  <!-- UI helpers mínimos (no tocan cálculo) -->
  <script>
    ...
    document.addEventListener('change', (e)=>{ if(e.target.id==='serviceType') toggleVisitControls(); });
    ...
    (function presetService(){
      ...
      var map = {
        ...
        'exoticos_mamiferos':'exoticos_mamiferos','mamiferos':'exoticos_mamiferos'
      };
      ...
      // ⚠️ No usamos localStorage para no preseleccionar si vienes desde Perfil.
